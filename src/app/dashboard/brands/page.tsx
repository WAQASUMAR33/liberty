        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-end">
                ...
                <button
                    ...
                    className="px-6 py-3.5 rounded-2xl premium-gradient text-white font-bold flex items-center gap-2.5 group shadow-[0_0_20px_rgba(59,130,246,0.25)] hover:shadow-[0_0_30px_rgba(59,130,246,0.35)] transition-all hover:scale-[1.02] active:scale-[0.98] self-start sm:self-auto cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-5 rounded-3xl glass border border-black/5 flex items-center justify-between shadow-sm hover:border-primary/20 transition-all">
                    <div>
            ...
            <div className="flex gap-4">
                <div className="relative flex-1 group">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-10 py-4 rounded-2xl glass border border-black/5 focus:outline-none focus:border-primary/50 transition-all font-medium text-foreground placeholder:text-foreground/40"
                        value={search}
                            ...
                            {loading ? (
                                ...
                                filteredBrands.map((brand) => (
                                    <tr key={brand.id} className="hover:bg-black/[0.02] transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-black/5 text-foreground/70">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex justify-center items-center gap-2">
                                                <button
                                                    ...
                                                    title="Edit Brand"
                                                    className="p-2.5 rounded-xl bg-black/5 hover:bg-primary/10 text-foreground/60 hover:text-primary transition-all cursor-pointer"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    title="Delete Brand"
                                                    className="p-2.5 rounded-xl bg-black/5 hover:bg-red-500/10 text-foreground/60 hover:text-red-500 transition-all cursor-pointer"
                                                >
                ...
                {deletingBrand && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-md rounded-3xl glass border border-black/5 p-6 md:p-8 overflow-hidden shadow-2xl bg-white"
                        >
                            ...
                            {(deletingBrand._count?.products || 0) > 0 && (
                                <div className="mb-6 p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-700 text-xs font-medium flex gap-2.5 items-start">
                            ...
                            <div className="flex gap-3 justify-end pt-2">
                                <button
                                    ...
                                    disabled={isDeleting}
                                    className="px-5 py-2.5 rounded-xl bg-black/5 hover:bg-black/10 font-bold text-foreground/70 transition-all cursor-pointer"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    disabled={isDeleting}
                                    className="px-5 py-2.5 rounded-xl bg-red-500 hover:bg-red-600 text-white font-bold shadow-lg shadow-red-500/25 transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50"
                                >
                                    {isDeleting ? (
                                        <>
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-md rounded-3xl glass border border-black/5 p-8 overflow-hidden shadow-2xl bg-white"
            >
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        onClick={onClose}
                        className="text-foreground/40 hover:text-foreground p-1.5 rounded-lg hover:bg-black/5 transition-all"
                    >
                        <X className="w-5 h-5" />
                    </button>
                </div>
                ...
                {error && (
                    <div className="mb-6 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-500 text-sm font-medium flex items-center gap-2.5">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <input
                            required
                            autoFocus
                            className="w-full px-4 py-3.5 rounded-xl bg-black/5 border border-black/5 focus:outline-none focus:border-primary transition-all font-medium text-foreground placeholder:text-foreground/40"
                    ...
                    <div className="pt-2">
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full py-4 rounded-2xl premium-gradient text-white font-bold shadow-xl hover:opacity-90 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                        >
                            {submitting ? (
                                <>
