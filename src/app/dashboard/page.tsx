    ...
    if (loading) {
        return (
            <div className="h-[60vh] flex flex-col items-center justify-center gap-4">
                <div className="w-12 h-12 border-4 border-primary/30 border-t-primary rounded-none-none animate-spin" />
        ...
        <div className="space-y-8 pb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        disabled={refreshing}
                        className="px-4 py-2.5 rounded-none-none glass border border-black/5 hover:bg-black/5 text-foreground/70 font-semibold text-xs transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50"
                    ...
                    <Link
                        href="/dashboard/pos"
                        className="px-4 py-2.5 rounded-none-none premium-gradient text-white font-bold text-xs shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all flex items-center gap-2 cursor-pointer"
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <motion.div
                    ...
                    className="p-6 rounded-none-none glass border border-black/5 bg-white shadow-xs hover:shadow-md hover:border-primary/20 transition-all group"
                >
                    <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-none-none bg-blue-500/10 text-blue-600 flex items-center justify-center font-bold">
                            <DollarSign className="w-6 h-6" />
                        </div>
                        <span className="text-[11px] font-bold px-2.5 py-1 rounded-none-none bg-blue-500/10 text-blue-700">
                ...
                <motion.div
                    ...
                    className="p-6 rounded-none-none glass border border-black/5 bg-white shadow-xs hover:shadow-md hover:border-emerald-500/20 transition-all group"
                >
                    <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-none-none bg-emerald-500/10 text-emerald-600 flex items-center justify-center font-bold">
                            <TrendingUp className="w-6 h-6" />
                        </div>
                        <span className="text-[11px] font-bold px-2.5 py-1 rounded-none-none bg-emerald-500/10 text-emerald-700">
                ...
                <motion.div
                    ...
                    className="p-6 rounded-none-none glass border border-black/5 bg-white shadow-xs hover:shadow-md hover:border-purple-500/20 transition-all group"
                >
                    <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-none-none bg-purple-500/10 text-purple-600 flex items-center justify-center font-bold">
                            <Package className="w-6 h-6" />
                        </div>
                        {stats.lowStockCount > 0 ? (
                            <span className="text-[11px] font-bold px-2.5 py-1 rounded-none-none bg-red-500/10 text-red-600 flex items-center gap-1">
                ...
                <motion.div
                    ...
                    className="p-6 rounded-none-none glass border border-black/5 bg-white shadow-xs hover:shadow-md hover:border-amber-500/20 transition-all group"
                >
                    <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-none-none bg-amber-500/10 text-amber-600 flex items-center justify-center font-bold">
                            <Wallet className="w-6 h-6" />
                        </div>
                        <span className="text-[11px] font-bold px-2.5 py-1 rounded-none-none bg-amber-500/10 text-amber-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 rounded-none-none glass border border-black/5 bg-white p-6 sm:p-8 shadow-xs flex flex-col justify-between">
                    <div>
                            ...
                            {recentSales.length === 0 ? (
                                ...
                                recentSales.map((sale: any) => {
                                    ...
                                    return (
                                        <div
                                            key={sale.id}
                                            className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-none-none bg-black/[0.015] hover:bg-black/[0.035] border border-black/5 transition-all gap-3"
                                        >
                                            <div className="flex items-center gap-3.5">
                                                <div className="w-10 h-10 rounded-none-none bg-primary/10 text-primary flex items-center justify-center font-bold text-sm shrink-0">
                                            ...
                                            <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center border-t sm:border-t-0 pt-2 sm:pt-0 border-black/5">
                                                ...
                                                <span
                                                    className={cn(
                                                        "text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-none-none mt-0.5",
                                                        isPaid
                ...
                <div className="rounded-none-none glass border border-black/5 bg-white p-6 sm:p-8 shadow-xs flex flex-col justify-between">
                    <div>
                        <div className="flex items-center justify-between mb-6">
                            <div>
                            ...
                            <span className="p-2 rounded-none-none bg-primary/10 text-primary">
                                        ...
                                        <div key={prod.id || i} className="space-y-1.5">
                                            <div className="flex items-center justify-between text-sm">
                                                <div className="flex items-center gap-2 min-w-0">
                                                    <span className="w-5 h-5 rounded-none-none bg-black/5 text-[10px] font-black flex items-center justify-center text-foreground/60 shrink-0">
                                                        {i + 1}
                                                    </span>
                                            ...
                                            {/* Progress Meter */}
                                            <div className="w-full bg-black/5 h-2 rounded-none-none overflow-hidden">
                                                <motion.div
                                                    initial={{ width: 0 }}
                                                    animate={{ width: `${percentage}%` }}
                                                    transition={{ duration: 0.8, delay: i * 0.1 }}
                                                    className="h-full premium-gradient rounded-none-none"
                                                />
                                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 rounded-none-none glass border border-black/5 bg-white p-6 sm:p-8 shadow-xs">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-none-none bg-amber-500/10 text-amber-600 flex items-center justify-center">
                    ...
                    {lowStockProducts.length === 0 ? (
                        <div className="p-8 rounded-none-none bg-emerald-500/5 border border-emerald-500/15 text-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                            {lowStockProducts.map((item: any) => (
                                <div
                                    key={item.id}
                                    className="p-4 rounded-none-none bg-red-500/[0.03] border border-red-500/15 flex items-center justify-between hover:bg-red-500/[0.06] transition-colors"
                                >
                                    ...
                                    <div className="text-right shrink-0">
                                        <span className={cn(
                                            "inline-block px-2.5 py-1 rounded-none-none text-xs font-black",
                                            item.stock <= 0
                ...
                <div className="rounded-none-none glass border border-black/5 bg-white p-6 sm:p-8 shadow-xs flex flex-col justify-between">
                    <div>
                        ...
                        <div className="space-y-4">
                            <Link
                                href="/dashboard/products"
                                className="flex items-center justify-between p-3.5 rounded-none-none bg-black/[0.02] hover:bg-black/[0.04] border border-black/5 transition-all group"
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-9 h-9 rounded-none-none bg-blue-500/10 text-blue-600 flex items-center justify-center font-bold">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-9 h-9 rounded-none-none bg-purple-500/10 text-purple-600 flex items-center justify-center font-bold">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-9 h-9 rounded-none-none bg-emerald-500/10 text-emerald-600 flex items-center justify-center font-bold">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-9 h-9 rounded-none-none bg-amber-500/10 text-amber-600 flex items-center justify-center font-bold">
